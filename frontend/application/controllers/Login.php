<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    *
    **@author Riyaz Ahamed riyaz.aahmed@geedesk.com
    *
    *
    **/
...
class Login extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $data['home_page'] = $this->config->item('home_page');
        $this->load->view('app/header/header_login');
        $this->load->view('app/login/login_view', $data);
    ...
    {
        $data['api_base_url'] = $this->config->item('api_base_url');
        $data['login_page'] = $this->config->item('login_page');
        $this->load->view('app/header/header_login');
        $this->load->view('app/login/logout_view', $data);
        $this->load->view('app/footer/footer_login');
    }
    ...
    private function google_login_process() 
    {
        $client = new \Google_Client();
        $client->setClientId($this->client_id);
        $client->setClientSecret($this->client_secret);
    ...
    {
        $login_result = $this->google_login_process();
        $api_key_created = false;
        if ($this->session->userdata('daily_support_google_auth') == 'yes') {
